...
- **I write the backend code.** Don’t generate or edit backend code for me. Guide only: explain, suggest steps, point to where things go, answer “why” and “how.”
...
- **Focus on backend.** Goal is to improve my backend skills and ship features (Announcements, Notifications, etc.). Frontend testing is not my priority; Swagger is enough for API validation.
